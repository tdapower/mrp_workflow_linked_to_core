<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="AddProposalsToBox.aspx.cs" Inherits="AddProposalsToBox" Title="Add Proposals to Boxes" %>
            ...
            <td>
                <asp:Panel ID="Panel1" runat="server" BackColor="Gainsboro" BorderColor="#C0C0FF"
                    ...
                    <table>
                        ...
                        <tr>
                            <td>
                                <asp:Label ID="Label4" runat="server" ForeColor="Gray" Style="text-align: left" Text="Policy"
                                    Width="111px"></asp:Label>
                            </td>
                            <td>
                                <asp:TextBox ID="txtSearchPolicy" runat="server" Width="189px" TabIndex="200" CssClass="input"></asp:TextBox>
                            </td>
                            <td>
                            </td>
                        </tr>
        ...
        <tr>
            <td>
                <div align="left" class="listunlinkstyle">
                    <asp:Panel ID="Panel3" runat="server" Height="372px" Style="z-index: 104;" Width="1038px"
                                    ...
                                    <table>
                                        <tr>
                                            <td style="width: 120px">
                                                <asp:ListBox ID="lstUnselected" runat="server" Height="200px" Width="300px" SelectionMode="Multiple">
                                                </asp:ListBox>
                                            </td>
                                            ...
                                            <td style="width: 125px">
                                                <asp:ListBox ID="lstSelected" runat="server" Height="200px" Width="300px" SelectionMode="Multiple">
                                                </asp:ListBox>
                                            </td>
                                        </tr>
                                    </table>
