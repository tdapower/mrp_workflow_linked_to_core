<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="MRPWorkflow.aspx.cs" Inherits="MRPWorkflow" Title="MRP Workflow" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    function jsValidateNum(obj)
	{
        ...
        function jsViewFollowup(){
         ...
         function jsViewManageMedicalPayments(){
                windowprop = "toolbar=1,Location=1,menubar=1,scrollbars=1,status=1,resizable=1,width='100%',height='100%'";
	            RefLink = "ManageMedicalPayments.aspx?ProposalNo=" +document.getElementById('<%= txtProposal.ClientID %>').value;
	            Child = open(RefLink,"Documents",windowprop);
        }
        
         function jsViewBlackboard(){
                windowprop = "toolbar=1,Location=1,menubar=1,scrollbars=1,status=1,resizable=1,width='100%',height='100%'";
	            RefLink = "Blackboard.aspx?ProposalNo=" +document.getElementById('<%= txtProposal.ClientID %>').value;
	            Child = open(RefLink,"Documents",windowprop);
        }
        
          function jsViewPendings(){
             if(document.getElementById('<%= txtProposal.ClientID %>').value != ""){
                windowprop = "toolbar=1,Location=1,menubar=1,scrollbars=1,status=1,resizable=1,width='100%',height='100%'";
	            RefLink = "Documents/ViewPendingDocuments.aspx?ProposalNo=" +document.getElementById('<%= txtProposal.ClientID %>').value;
	            Child = open(RefLink,"Pending_Documents",windowprop);
	        }
        }
    </script>
                ...
                <asp:Panel ID="pnlSearch" runat="server" BackColor="Gainsboro" BorderColor="#C0C0FF"
                    ...
                    <table style="width: 562px">
                        ...
                        <tr>
                            ...
                            <td style="width: 140px">
                                &nbsp;
                                <asp:Button ID="btnOpenDashboard" runat="server" CssClass="button" OnClick="btnOpenDashboard_Click"
                                    TabIndex="207" Text="Dashboard" Width="100px" />
                            </td>
                            <td>
                            </td>
                        </tr>
                        ...
                        <table style="width: 950px; height: 188px" cellpadding="2" cellspacing="5">
                            ...
                            <tr>
                                ...
                                <td colspan="3">
                                    <asp:DropDownList ID="ddlStatus" runat="server" Style="z-index: 109;" Width="188px"
                                        TabIndex="205" CssClass="dropDown" OnSelectedIndexChanged="ddlStatus_SelectedIndexChange"
                                        AutoPostBack="true">
                                    </asp:DropDownList>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <asp:CheckBox ID="chkLifeassured1BeneficiaryCover" runat="server" Text=" Beneficiary cover"
                                        AutoPostBack="True" OnCheckedChanged="chkLifeassured1BeneficiaryCover_CheckedChanged" /><br />
                                </td>
                                <td>
                                ...
                                <td style="width: 338px">
                                    ...
                                    <asp:CheckBox ID="chkLifeassured2BeneficiaryCover" runat="server" Text=" Beneficiary cover"
                                        AutoPostBack="True" OnCheckedChanged="chkLifeassured2BeneficiaryCover_CheckedChanged" Visible="false"/><br />
                                </td>
                            </tr>
                            <tr>
                                <td>
                            ...
                            <tr>
                                <td colspan="4" align="center">
                                    ...
                                    <asp:Button ID="btnSave" runat="server" TabIndex="24" Text="Save" Width="100px" OnClick="btnSave_Click"
                                        CssClass="button" />
                                    <asp:Button ID="btnCancel" runat="server" TabIndex="25" Text="Cancel Workflow" Width="150px"
                                        OnClick="btnCancel_Click" CssClass="button" />
                                    <asp:Button ID="btnFollowup" runat="server" TabIndex="25" Text="Followup" Width="100px"
                                        CssClass="button" />
                                    <asp:Button ID="btnPendings" runat="server" TabIndex="25" Text="Pendings" Width="100px"
                                        CssClass="button" />
                                    <asp:Button ID="btnDocuments" runat="server" TabIndex="25" Text="Documents" Width="100px"
                                        CssClass="button" />
                                    <asp:Button ID="btnManageMedicalPayments" runat="server" CssClass="button" TabIndex="25"
                                        Text="Manage Medical Payments" Width="200px" />
                                    <asp:Button ID="btnOpenBlackboard" runat="server" CssClass="button" TabIndex="25"
                                        Text="Open Blackboard" Width="200px" />
                                    <div>
                                    </div>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td align="center" colspan="4">
                                    <asp:LinkButton ID="btnViewConfirmationCover" runat="server" CssClass="button" Width="150px"
                                        Visible="false">View Confirmation Cover</asp:LinkButton>
                                    <ajaxToolkit:ModalPopupExtender ID="ModalPopupExtender2" runat="server" PopupControlID="pnlViewConfirmationCover"
                                        TargetControlID="btnViewConfirmationCover" CancelControlID="btnCloseViewConfirmationCover"
                                        BackgroundCssClass="Background">
                                    </ajaxToolkit:ModalPopupExtender>
                                    <asp:Panel ID="pnlViewConfirmationCover" runat="server" CssClass="Popup" align="center"
                                        Style="display: none">
                                        <iframe style="width: 1095px; height: 600px; background-color: White;" id="IframeViewConfirmationCover"
                                            runat="server" src="Common/CrystalDocumentViewer.aspx"></iframe>
                                        <br />
                                        <asp:Button ID="btnCloseViewConfirmationCover" runat="server" Text="Close" CssClass="button" />
                                    </asp:Panel>
                                    <asp:LinkButton ID="btnViewPendingCover" runat="server" CssClass="button" Width="150px"
                                        Visible="false">View Pending Cover</asp:LinkButton>
                                    <ajaxToolkit:ModalPopupExtender ID="ModalPopupExtender3" runat="server" PopupControlID="pnlViewPendingCover"
                                        TargetControlID="btnViewPendingCover" CancelControlID="btnCloseViewPendingCover"
                                        BackgroundCssClass="Background">
                                    </ajaxToolkit:ModalPopupExtender>
                                    <asp:Panel ID="pnlViewPendingCover" runat="server" CssClass="Popup" align="center"
                                        Style="display: none">
                                        <iframe style="width: 1095px; height: 600px; background-color: White;" id="IframeViewPendingCover"
                                            runat="server" src="Common/CrystalDocumentViewer.aspx"></iframe>
                                        <br />
                                        <asp:Button ID="btnCloseViewPendingCover" runat="server" Text="Close" CssClass="button" />
                                    </asp:Panel>
                                </td>
                            </tr>
                            <tr>
                                <td align="center" colspan="4">
                                    <asp:Button ID="btnSendConfirmationCover" runat="server" CssClass="button" OnClick="btnSendConfirmationCover_Click"
                                        TabIndex="25" Text="Send Confirmation Cover" Width="200px" Visible="false" />
                                    <asp:Button ID="btnSendPendingCover" runat="server" CssClass="button" OnClick="btnSendPendingCover_Click"
                                        TabIndex="25" Text="Send Pending Cover" Width="200px" Visible="false" />
                                </td>
                            </tr>
                            <tr>
                                <td colspan="4">
                                    <CR:CrystalReportViewer ID="Crystalreportviewer1" runat="server" AutoDataBind="True"
                                        DisplayGroupTree="False" Height="799px" Width="1095px" EnableDatabaseLogonPrompt="False"
                            ...
                            <tr>
                                <td colspan="4" align="center">
                                    <asp:LinkButton ID="lnkBtnAttachment" runat="server" CssClass="button" Width="150px">Upload Documents</asp:LinkButton>
                                    ...
                                    <asp:Panel ID="Panl1" runat="server" CssClass="Popup" align="center" Style="display: none">
                                        <iframe style="width: 800px; height: 600px;" id="irm1" runat="server" src="Common/DocumentUploader.aspx">
                                        </iframe>
                                        <br />
                                        <asp:Button ID="btnClose" runat="server" Text="Close" CssClass="button" />
                                    </asp:Panel>
                                    <asp:LinkButton ID="lnkBtnAttachedDocs" runat="server" CssClass="button" Width="180px">View Uploaded Documentss</asp:LinkButton>
                                    ...
                                    <asp:Panel ID="Panel2" runat="server" align="center" CssClass="Popup" Style="display: none;
                            ...
                            <tr>
                                <td colspan="4">
                                    <CR:CrystalReportViewer ID="LetterViewer" runat="server" AutoDataBind="True" DisplayGroupTree="False"
                                        ...
                                        ReuseParameterValuesOnRefresh="True" Visible="false"></CR:CrystalReportViewer>
                                </td>
                            </tr>
                        </table>
                        <table>
