<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="BlacklistNIC.aspx.cs" Inherits="BlacklistNIC" Title="Blacklist NIC" %>
            ...
            <td>
                <asp:Panel ID="Panel1" runat="server" BackColor="Gainsboro" BorderColor="#C0C0FF"
                    ...
                    <table>
                        ...
                        <tr>
                            <td>
                                <asp:Label ID="Label2" runat="server" ForeColor="Gray" Style="text-align: left" Text="NIC"
                                    Width="111px"></asp:Label>
                            </td>
                            <td>
                                <asp:TextBox ID="txtSearchNIC" runat="server" CssClass="input" Width="189px"></asp:TextBox>
                            </td>
                            <td>
                            </td>
                        </tr>
                ...
                <div align="left" class="listunlinkstyle">
                    <asp:Panel ID="Panel3" runat="server" Height="212px" Style="z-index: 104;" Width="1038px"
                        ...
                        <table style="width: 564px; height: 100px">
                            ...
                            <tr>
                                <td>
                                    <asp:Label ID="Label4" runat="server" Font-Names="Verdana" Font-Size="9pt" Text="NIC"
                                        Width="150px"></asp:Label>
                                </td>
                                <td>
                                    <asp:TextBox ID="txtNIC" runat="server" Width="150px"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <asp:Label ID="Label3" runat="server" Font-Names="Verdana" Font-Size="9pt" Text="Is Blacklisted"
                                        Width="150px"></asp:Label>
                                </td>
                                <td>
                                    </asp:TextBox><asp:CheckBox ID="chkIsBlacklisted" runat="server" />
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <asp:Label ID="Label5" runat="server" Font-Names="Verdana" Font-Size="9pt" Text="Remarks"
                                        Width="150px"></asp:Label>
                                </td>
                                <td>
