<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="SetupSigningPerson.aspx.cs" Inherits="SetupSigningPerson" Title="Setup Signing Persons" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table style="z-index: 103; left: 0px; position: absolute; top: -54px">
            ...
            <td>
                <asp:Panel ID="Panel1" runat="server" BackColor="Gainsboro" BorderColor="#C0C0FF"
                    ...
                    <table>
                        ...
                        <tr>
                            <td>
                                <asp:Label ID="Label2" runat="server" ForeColor="Gray" Style="text-align: left" Text="Signing Person"
                                    Width="111px"></asp:Label>
                            </td>
                            <td>
                                <asp:TextBox ID="txtSearchSigningPerson" runat="server" 
                        ...
                        <tr>
                            <td>
                                <asp:Label ID="Label1" runat="server" ForeColor="Gray" Style="text-align: left" Text="Designation"
                                    Width="111px"></asp:Label>
                            </td>
                            <td>
                                <asp:TextBox ID="txtSearchDesignation" runat="server" 
                                    Width="189px" TabIndex="200"  CssClass="input"></asp:TextBox>
                            </td>
                            <td>
                            </td>
        ...
        <tr>
            <td>
                <asp:Panel ID="pnlSigningPersonGrid" runat="server" Height="113px" ScrollBars="Vertical"
                    Style="z-index: 102;" Width="1043px" BorderColor="#C0C0FF" BorderWidth="1px">
                    <asp:GridView ID="grdSigningPerson" runat="server" BackColor="White" BorderColor="#CCCCCC"
                        BorderStyle="None" BorderWidth="1px" CellPadding="3" Font-Bold="False" Font-Names="Tahoma"
                        Font-Size="8pt" Style="z-index: 102;" Width="995px" OnSelectedIndexChanged="grdSigningPerson_SelectedIndexChanged"
                        OnRowDataBound="grdSigningPerson_RowDataBound">
                ...
                <div align="left" class="listunlinkstyle">
                    <asp:Panel ID="Panel3" runat="server" Height="222px" Style="z-index: 104;" Width="1038px"
                        ...
                        <table style="width: 464px; height: 100px">
                            <tr>
                                <td colspan="2">
                                    <asp:TextBox ID="txtSigningPersonCode" runat="server" Visible="false"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <asp:Label ID="Label18" runat="server" Font-Bold="False" Font-Names="Verdana" Font-Size="9pt"
                                        Style="z-index: 106;" Text="Signing Person" Width="150px"></asp:Label>
                                </td>
                                <td>
                                    <asp:TextBox ID="txtSigningPerson" runat="server" 
