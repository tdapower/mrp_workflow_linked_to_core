<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="PendingDocCategorySetup.aspx.cs" Inherits="PendingDocCategorySetup"
    Title="Pending Category Setup" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table style="z-index: 103; left: 0px; position: absolute; top: -54px">
            ...
            <td>
                <asp:Panel ID="Panel1" runat="server" BackColor="Gainsboro" BorderColor="#C0C0FF"
                    ...
                    <table>
                        ...
                        <tr>
                            <td>
                                <asp:Label ID="Label2" runat="server" ForeColor="Gray" Style="text-align: left" Text="Category"
                                    Width="111px"></asp:Label>
                            </td>
                            <td>
                                <asp:TextBox ID="txtSearchDocCategory" runat="server" Width="189px" TabIndex="200"
        ...
        <tr>
            <td>
                <asp:Panel ID="pnlDocCategoryGrid" runat="server" Height="113px" ScrollBars="Vertical"
                    Style="z-index: 102;" Width="1043px" BorderColor="#C0C0FF" BorderWidth="1px">
                    <asp:GridView ID="grdDocCategory" runat="server" BackColor="White" BorderColor="#CCCCCC"
                        BorderStyle="None" BorderWidth="1px" CellPadding="3" Font-Bold="False" Font-Names="Tahoma"
                        Font-Size="8pt" Style="z-index: 102;" Width="995px" OnSelectedIndexChanged="grdDocCategory_SelectedIndexChanged"
                        OnRowDataBound="grdDocCategory_RowDataBound">
                ...
                <div align="left" class="listunlinkstyle">
                    <asp:Panel ID="Panel3" runat="server" Height="222px" Style="z-index: 104;" Width="1038px"
                        ...
                        <table style="width: 464px; height: 100px">
                            <tr>
                                <td colspan="2">
                                    <asp:TextBox ID="txtDocCategoryCode" runat="server" Visible="false"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <asp:Label ID="Label18" runat="server" Font-Bold="False" Font-Names="Verdana" Font-Size="9pt"
                                        Style="z-index: 106;" Text="Document Category" Width="150px"></asp:Label>
                                </td>
                                <td>
                                    <asp:TextBox ID="txtDocCategory" runat="server" MaxLength="250" Style="z-index: 105;"
