...
public partial class PendingReportATC : System.Web.UI.Page
{
    ...
    public DataTable getPendings()
    {
        ...
        selectQuery = "select t.* from mrp_wf_get_pendings_atc t where  t.\"System\"='" + Request.Cookies["WORKFLOW_CHOICE"].Value.ToString() + "' AND t.\"Bank\"<>'HNB' order by t.\"Job No\" ";
