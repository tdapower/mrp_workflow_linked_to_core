...
// Date              :22/12/2016
// Reviewed By       :
// Description       :Medical Payment Report 
//******************************************
using System;
using System.Data;
...
public partial class MedicalPaymentReport : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            try
            {
                ...
                CRpm3.Name = "paymentMode";
                CRpm3.DefaultValue = Request.Params["paymentMode"];
                CrystalReportSource1.Report.Parameters.Add(CRpm3);

                CrystalDecisions.Web.Parameter CRpm4 = new CrystalDecisions.Web.Parameter();
                CRpm4.Name = "wfType";
                CRpm4.DefaultValue = Request.Cookies["WORKFLOW_CHOICE"].Value.ToString();
