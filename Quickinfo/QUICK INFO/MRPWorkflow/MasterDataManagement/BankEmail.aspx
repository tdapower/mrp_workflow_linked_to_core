<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="BankEmail.aspx.cs" Inherits="BankEmail" Title="Bank Emails" %>
            ...
            <td>
                <asp:Panel ID="Panel1" runat="server" BackColor="Gainsboro" BorderColor="#C0C0FF"
                    ...
                    <table>
                        ...
                        <tr>
                            <td>
                                <asp:Label ID="Label7" runat="server" ForeColor="Gray" Style="text-align: left" Text="HNBA Branch Code"
                                    Width="111px"></asp:Label>
                            </td>
                            <td>
                                <asp:TextBox ID="txtSearchHNBABranchCode" runat="server" CssClass="input" Width="189px"></asp:TextBox>
                            </td>
                            <td>
                            </td>
                        </tr>
                    ...
                    <asp:Panel ID="Panel3" runat="server" Height="212px" Style="z-index: 104;" Width="1038px"
                        ...
                        <table style="width: 564px; height: 100px">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList ID="ddlBankCode" runat="server" Style="z-index: 109;" Width="188px"
                            ...
                            <tr>
                                <td>
                                    <asp:Label ID="Label9" runat="server" Font-Names="Verdana" Font-Size="9pt" Text="HNBA Branch Code"
                                        Width="150px"></asp:Label>
                                </td>
                                <td>
                                    <asp:DropDownList ID="ddlHNBABranchCode" runat="server" Style="z-index: 109;" Width="188px"
                                        TabIndex="205" CssClass="dropDown">
                                    </asp:DropDownList>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <asp:Label ID="Label3" runat="server" Font-Names="Verdana" Font-Size="9pt" Text="Bank Email"
                                        Width="150px"></asp:Label>
                                </td>
                                <td>
                                    <asp:TextBox ID="txtBankEmail" runat="server" Width="500px"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <asp:Label ID="Label5" runat="server" Font-Names="Verdana" Font-Size="9pt" Text="Bancassurance Email"
                                        Width="150px"></asp:Label>
                                </td>
                                <td>
                                    <asp:TextBox ID="txtBancassuranceEmail" runat="server" Width="500px"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td>
