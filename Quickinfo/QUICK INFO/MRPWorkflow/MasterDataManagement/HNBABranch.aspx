<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="HNBABranch.aspx.cs" Inherits="HNBABranch" Title="HNBA Branch" %>
            ...
            <td>
                <asp:Panel ID="Panel1" runat="server" BackColor="Gainsboro" BorderColor="#C0C0FF"
                    ...
                    <table>
                        ...
                        <tr>
                            <td>
                                <asp:Label ID="Label2" runat="server" ForeColor="Gray" Style="text-align: left" Text="HNBA Branch Code"
                ...
                <div align="left" class="listunlinkstyle">
                    <asp:Panel ID="Panel3" runat="server" Height="212px" Style="z-index: 104;" Width="1038px"
                        ...
                        <table style="width: 564px; height: 100px">
                            ...
                            <tr>
                                <td>
                                    <asp:Label ID="Label4" runat="server" Font-Names="Verdana" Font-Size="9pt" Text="HNBA Branch Code"
                                        Width="150px"></asp:Label>
                                </td>
                                <td>
                                    <asp:TextBox ID="txtHNBABranchCode" runat="server" Width="100px"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <asp:Label ID="Label3" runat="server" Font-Names="Verdana" Font-Size="9pt" Text="Branch Name"
                                        Width="150px"></asp:Label>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <asp:Label ID="Label5" runat="server" Font-Names="Verdana" Font-Size="9pt" Text="E-mail"
                                        Width="150px"></asp:Label>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <asp:Label ID="Label1" runat="server" Font-Names="Verdana" Font-Size="9pt" Text="Status"
                                        Width="150px"></asp:Label>
                                </td>
                                <td>
