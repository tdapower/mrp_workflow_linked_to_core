<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="MedicalLab.aspx.cs" Inherits="MedicalLab" Title="Medical Lab" %>
        ...
        <tr>
            <td>
                <asp:Panel ID="Panel1" runat="server" BackColor="Gainsboro" BorderColor="#C0C0FF"
                    BorderWidth="1px" ForeColor="Gainsboro" Height="100px" Style="z-index: 100;"
                    Width="489px">
                    <table>
                        <tr>
                            <td>
                        ...
                        <tr>
                            <td>
                                <asp:Label ID="Label2" runat="server" ForeColor="Gray" Style="text-align: left" Text="Party Code"
                                    Width="111px"></asp:Label>
                            </td>
                            <td>
                                <asp:TextBox ID="txtSearchPartyCode" runat="server" CssClass="input" Width="189px"></asp:TextBox>
                            </td>
                            <td>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <asp:Label ID="Label6" runat="server" ForeColor="Gray" Style="text-align: left" Text="Lab Name"
                                    Width="111px"></asp:Label>
                            </td>
                            <td>
                                <asp:TextBox ID="txtSearchLabName" runat="server" CssClass="input" Width="189px"></asp:TextBox>
                            </td>
                            <td>
                            </td>
                        </tr>
                ...
                <div align="left" class="listunlinkstyle">
                    <asp:Panel ID="Panel3" runat="server" Height="212px" Style="z-index: 104;" Width="1038px"
                        ...
                        <table style="width: 564px; height: 100px">
                            ...
                            <tr>
                                <td>
                                    <asp:Label ID="Label4" runat="server" Font-Names="Verdana" Font-Size="9pt" Text="Party Code"
                                        Width="150px"></asp:Label>
                                </td>
                                <td>
                                    <asp:TextBox ID="txtPartyCode" runat="server" Width="300px"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <asp:Label ID="Label3" runat="server" Font-Names="Verdana" Font-Size="9pt" Text="Lab Name"
                                        Width="150px"></asp:Label>
                                </td>
                                <td>
                                    <asp:TextBox ID="txtLabName" runat="server" Width="500px"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <asp:Label ID="Label5" runat="server" Font-Names="Verdana" Font-Size="9pt" Text="Address Line 1"
                                        Width="150px"></asp:Label>
                                </td>
                                <td>
                                    <asp:TextBox ID="txtAddressLine1" runat="server" Width="500px" TextMode="MultiLine"
                                        Rows="3"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <asp:Label ID="Label1" runat="server" Font-Names="Verdana" Font-Size="9pt" Text="Address Line 2"
                                        Width="150px"></asp:Label>
                                </td>
                                <td>
                                    <asp:TextBox ID="txtAddressLine2" runat="server" Rows="3" TextMode="MultiLine" Width="500px"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <asp:Label ID="Label7" runat="server" Font-Names="Verdana" Font-Size="9pt" Text="Address Line 3"
                                        Width="150px"></asp:Label>
                                </td>
                                <td>
                                    <asp:TextBox ID="txtAddressLine3" runat="server" Rows="3" TextMode="MultiLine" Width="500px"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td>
