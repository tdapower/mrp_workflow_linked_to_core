...
var MENU_ITEMS = [
	...
	['Docs & Info', null, null,
		...
		['Menu Builder', '../_builder/index.html'],
				['Motor Searching', 'Motor.aspx'],
		['Non Motor Searching', 'http://www.softcomplex.com/support.html'],
		['life Searching', 'LifeData.aspx'],
		['PUR Intimations', 'RequestList.aspx'],
		['NM Intimations', 'NM_Email.aspx'],
	],
