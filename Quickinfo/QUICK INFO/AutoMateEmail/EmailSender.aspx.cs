...
public partial class SubMenuSetup : System.Web.UI.Page
{
    ...
    private void SearchData()
    {
        ...
        selectQuery = "SELECT T.MAE_EMAIL_ID,T.MAE_EMAIL_DESC AS \"E-Mail Desc\",T.MAE_EMAIL_ADDRESS AS \"E-Mail Address\",T.MAE_EMAIL_STATUS AS \"Email Status\",T.MAE_EMAIL_ID FROM WF_MIS_AUTOMATED_EMAIL_SENDERS T " +
    ...
    {
        Response.Redirect("EmailSender.aspx");
    }
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            if (Session["SubMenuSetupMode"].ToString() == "NEW")
            {
                spProcess = new OracleCommand("INSERT_WF_MIS_EMAIL_ADDRESS");
            }
            else if (Session["SubMenuSetupMode"].ToString() == "UPDATE")
            {
                spProcess = new OracleCommand("UPDATE_WF_MIS_EMAIL_ADDRESS");
            }
            ...
            spProcess.Parameters.Add("V_MAE_EMAIL_ADDRESS", OracleType.VarChar, 100).Value = txtSubMenuName.Text;
