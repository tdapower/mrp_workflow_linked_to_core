<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="UserRoleSetup.aspx.cs" Inherits="UserRoleSetup" Title="User Role" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
  ...
  <link rel="stylesheet" type="text/css" href="~/Styles/StyleSheet.css"  />
    ...
    <table style="z-index: 103; left: 0px; position: absolute; top: -54px">
            ...
            <td>
                <asp:Panel ID="Panel1" runat="server" BackColor="Gainsboro" BorderColor="#C0C0FF"
                    ...
                    <table>
                        ...
                        <tr>
                            <td>
                                <asp:Label ID="Label2" runat="server" ForeColor="Gray" Style="text-align: left" Text="User Role Name"
                                    Width="111px"></asp:Label>
                            </td>
                            <td>
                                <asp:TextBox ID="txtSearchUserRoleName" runat="server" Width="189px" TabIndex="200"
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtSearchDescription" runat="server" Width="189px" TabIndex="201"
                                    CssClass="input"></asp:TextBox>
                            </td>
                            <td>
                            </td>
        ...
        <tr>
            <td>
                <asp:Panel ID="pnlUserRoleGrid" runat="server" Height="113px" ScrollBars="Vertical"
                            ...
                            <tr>
                                <td>
                                    <asp:Label ID="Label18" runat="server" Font-Bold="False" Font-Names="Verdana" Font-Size="9pt"
                                        Style="z-index: 106;" Text="User Role Name" Width="150px"></asp:Label>
                                </td>
                                <td>
                                    <asp:TextBox ID="txtUserRoleName" runat="server" MaxLength="250" Style="z-index: 105;"
