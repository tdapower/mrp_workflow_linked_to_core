<%@ Page Language="C#" MasterPageFile="../MasterPage.master" AutoEventWireup="true"
    CodeFile="SubMenuSetup.aspx.cs" Inherits="SubMenuSetup" Title="Sub Menu" %>
            ...
            <td>
                <asp:Panel ID="Panel1" runat="server" BackColor="Gainsboro" BorderColor="#C0C0FF"
                    ...
                    <table>
                        ...
                        <tr>
                            <td>
                                <asp:Label ID="Label3" runat="server" ForeColor="Gray" Style="text-align: left" Text="Sub Menu Name"
                                    Width="111px"></asp:Label>
                            </td>
                            <td>
                                <asp:TextBox ID="txtSearchSubMenuName" runat="server"
                        ...
                        <tr>
                            <td>
                                <asp:Label ID="Label1" runat="server" ForeColor="Gray" Style="text-align: left" Text="Description"
                                    Width="111px"></asp:Label>
                            </td>
                            <td>
                                <asp:TextBox ID="txtSearchDescription" runat="server"
                                    Width="189px" TabIndex="201"  CssClass="input"></asp:TextBox>
                            </td>
                            <td>
                            </td>
                        </tr>
                            ...
                            <tr>
                                <td>
                                    <asp:Label ID="Label18" runat="server" Font-Bold="False" Font-Names="Verdana" Font-Size="9pt"
                                        Style="z-index: 106;" Text="Main Menu Name" Width="150px"></asp:Label>
                                </td>
                                <td>
                                    <asp:DropDownList ID="ddlMainMenu" runat="server" Style="z-index: 109;" Width="188px"
                                        TabIndex="205"   CssClass="dropDown">
                                    </asp:DropDownList>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <asp:Label ID="Label5" runat="server" Font-Bold="False" Font-Names="Verdana" Font-Size="9pt"
                                        Style="z-index: 106;" Text="Sub Menu Name" Width="150px"></asp:Label>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <asp:Label ID="Label6" runat="server" Font-Bold="False" Font-Names="Verdana" Font-Size="9pt"
                                        Style="z-index: 106;" Text="Page Path" Width="150px"></asp:Label>
                                </td>
                                <td>
                                    <asp:TextBox ID="txtPagePath" runat="server" 
                                        Height="16px" MaxLength="250" Style="z-index: 105;"
